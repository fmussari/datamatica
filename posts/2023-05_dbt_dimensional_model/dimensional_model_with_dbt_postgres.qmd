...
The first version of the date dimension was created using `dbt_utils`, based on [As of Date Tables](https://automate-dv.readthedocs.io/en/latest/tutorial/tut_as_of_date/) tutorial. I simply changed  `start_date` and `end_date` statements to get the aforementioned earliest and latest dates from `salesorderheader`. The transformation ended looking like this:
